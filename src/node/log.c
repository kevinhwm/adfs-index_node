...
void log_out(const char *module, const char *info, LOG_LEVEL level)
{
    ...
    switch (level) {
	case 0:
	    fprintf(f_log, "L0-system\t"); break;
	case 1:
	    fprintf(f_log, "L1--fatal\t"); break;
	case 2:
	    fprintf(f_log, "L2--error\t"); break;
	case 3:
	    fprintf(f_log, "L3---warn\t"); break;
	case 4:
	    fprintf(f_log, "L4---info\t"); break;
	case 5:
	    fprintf(f_log, "L5--debug\t"); break;
    }
